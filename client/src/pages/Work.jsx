export default function work(){
    return(
        <div className="w-full flex flex-col items-center justify-center mt-10">
            ...
            <div className="sections mt-6 flex flex-wrap gap-4 justify-center">
                <button className="px-4 py-2 bg-gray-100 rounded-full text-sm font-medium text-gray-700 hover:bg-gray-200 transition cursor-pointer">
                    profile
                </button>
                <button className="px-4 py-2 bg-gray-100 rounded-full text-sm font-medium text-gray-700 hover:bg-gray-200 transition cursor-pointer">
                    ecommerce
