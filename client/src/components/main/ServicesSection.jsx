      ...
      <div className="max-w-7xl mx-auto px-4 text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            <div
              key={index}
              className=" bg-white cursor-pointer shadow-md rounded-lg p-6  hover:shadow-xl transition transform hover:-translate-y-2 hover:bg-green-50"
            >
        ...
        <div className="mt-10">
          <button className="inline-flex cursor-pointer items-center px-8 py-4  shadow-md rounded-lg bg-white text-black font-semibold   hover:shadow-xl transition transform hover:bg-green-50 hover:scale-105">
            Click for More
